...
public class ShoujiHuaFei {
    ...
    public static final String key ="d816e2682c2b10f808a5e07a2c6e0a58";//申请的接口Appkey
...
//---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public static String onlineOrder(String phone,int cardnum,String orderid) throws Exception{
        String result = null;
//Md5Util工具类
        String sign = Md5Util.getMD5String(openId+key+phone+cardnum+orderid);
    ...
    public static String yuE() throws Exception{
        ...
        String sign = Md5Util.getMD5String(openId+key+timestamp);
