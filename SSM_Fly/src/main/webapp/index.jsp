...
<div class="main-container" id="main-container">
	...
	<div class="main-container-inner">
		...
		<div class="sidebar" id="sidebar">
			...
			<div id="menu_style" class="menu_style">
				<ul class="nav nav-list" id="nav_list">
					...
					<li>
						<a href="<c:if test="${!empty m.children}">${m.url}</c:if>" class="dropdown-toggle"><i class="${m.icon}"></i><span class="menu-text"> ${m.name} </span><c:if test="${!empty m.children}"><b class="arrow icon-angle-down"></b></c:if></a>
						<c:if test="${!empty m.children}">
						<ul class="submenu">
							<c:forEach items="${m.children}" var="c">
							<li class="home"><a href="javascript:void(0)" name="${c.url}" title="${c.name}" class="iframeurl"><i class="icon-double-angle-right"></i>${c.name}</a></li>
							</c:forEach>
						</ul>
						</c:if>
					</li>
		...
		<div class="main-content">
			...
			<iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="FlightRecord_index.do">  </iframe>
