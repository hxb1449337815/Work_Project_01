    ...
    <div class="d_Confirm_Order_style">
        ...
        <table class="table table-striped table-bordered table-hover" id="sample-table">
            ...
            <tr>
                      ...
                      <td >${f.post}</td>
                      <td>${f.remark}</td>
                      <td><fmt:formatDate value="${f.addTime}" pattern="yyyy-MM-DD HH:mm:ss"/></td>
                      <td class="td-status"><span class="<c:choose><c:when test="${f.state==true}">label label-success radius</c:when><c:otherwise>btn btn-default radius</c:otherwise></c:choose>">
                          <c:choose><c:when test="${f.state==true}">正常</c:when><c:otherwise>不正常</c:otherwise></c:choose>
                      </span></td>
                    </tr>
                  </c:forEach>
          </tbody>
