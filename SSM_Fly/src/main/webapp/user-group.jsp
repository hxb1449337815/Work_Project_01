        ...
        <tr>
         ...
         <td class="td-status"><span class="label label-success radius">正常</span></td>
          ...
          <a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a>
           <a title="用户组详情" href="/roleIdToUser.do?id=${r.id}&roles=${r.name}" class="btn btn-xs btn-info Refund_detailed">用户组详情</a>
           <a title="修改权限" href="javascript:;"  onclick="member_edit(${r.id})" class="btn btn-xs btn-warning">修改权限</a>
